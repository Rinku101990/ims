<div class="top-bar clearfix">
    <div class="page-title">
        <h4>Route Schedules</h4></div>
</div>
<div class="main-container">
    <div class="container-fluid">
        <div class="row gutter">
            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"><a href="<?php echo base_url('super/transport/addSchedules');?>" class="btn btn-danger"><i class="fa fa-plus"></i> Add Route Schedules</a></div>
                            ...
                            <table id="fixedHeader" class="table table-striped table-bordered no-margin" cellspacing="0" width="100%">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Ramesh Gupta</td>
                                        <td>DL25C236</td>
                                        <td>New Ashok nagar to Noida Sector 3</td>
                                        <td>
                                            <label class="switch">
