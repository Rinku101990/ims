...
<div class="main-container">
  <div class="container-fluid">
    <div class="row gutter">
      <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><p><a href="<?php echo base_url('super/events/add');?>" class="btn btn-danger btn-xs"><i class="fa fa-plus"></i> Create Event</a></p></div>
