<div class="top-bar clearfix">
    <div class="page-title">
        <h4>Employees Attendance</h4></div>
</div>
<div class="main-container">
    <div class="container-fluid">
        <div class="row gutter">
          <div class="col-lg-6">
              <a href="<?php echo base_url('super/employeeAttendance/add');?>" class="btn btn-danger pull-left"><i class="fa fa-plus"></i> Add Attendance </a>
